/// Typst Library Wrapper
///
/// Implemented by [tfachmann](https://github.com/tfachmann/) under Apache-2.0 license.
///
/// Original source code at [tfachmann/typst-as-library](https://github.com/tfachmann/typst-as-library).
